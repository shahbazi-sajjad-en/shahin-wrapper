//package biz.espc.shahin.service.impl;
//
//import biz.espc.shahin.dto.threeWay.token.ThreeWayTokenRequestDto;
//import biz.espc.shahin.dto.threeWay.token.ThreeWayTokenResponseDto;
//import biz.espc.shahin.dto.twoWay.token.TwoWayTokenRequestDto;
//import biz.espc.shahin.service.ThreeWayService;
//import biz.espc.shahin.util.UniRestUtils;
...
//
//@Component
//public class ThreeWayServiceImpl implements ThreeWayService {
//
...
//
//    @Override
//    public ThreeWayTokenResponseDto getThreeWayToken(ThreeWayTokenRequestDto requestDto) {
//        String tokenResStr = UniRestUtils.get(
//                createUrlPath(getTokenPath)
//                , requestDto, new HashMap<>() {{
//                    put("Authorization", basicAth);
//                }});
//        return gson.fromJson(tokenResStr, ThreeWayTokenResponseDto.class);
//    }
//}
