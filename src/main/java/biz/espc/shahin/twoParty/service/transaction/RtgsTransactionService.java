...
import static biz.espc.shahin.util.ShahinUtil.SUCCESS_COMMENT;
import static biz.espc.shahin.util.ShahinUtil.TRANSACTION_FAILED_COMMENT;
import static biz.espc.shahin.util.ShahinUtil.firstOrNull;
import static biz.espc.shahin.util.ShahinUtil.setHeader;

/**
 * author: Ebrahim Sheyki
 * Created on: 2/7/2026  4:18 PM
 */
@Service
@RequiredArgsConstructor
public class RtgsTransactionService {

    @Value("${shahin.transaction.path}")
    private String rtgsTransactionPath;
    ...
    public Mono<TransactionResponseDto.Combined> doRtgsTransaction(TransactionRequestDto requestDto) {
